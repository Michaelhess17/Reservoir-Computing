...
class hayes_special_Delay_Res(DelayReservoir):
	"""
	This special class of delay reservoir tries to find a "correction" term that would allow hayes to bridge that 1 * 10 ^ -6 gap in amplitude in the lower bound especially. 
	"""
